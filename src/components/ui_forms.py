...
def renderizar_formulario_contexto():
    ...
    with col2:
        tempo_casa = st.selectbox("Tempo de Empresa:", ["Menos de 6 meses", "6 meses a 1 ano", "1 a 3 anos", "Mais de 3 anos"])
    with col3:
        perfil_comportamental = st.selectbox("Perfil Comportamental:", ["Analítico", "Comunicador", "Executor", "Planejador"])
        
    entregas_recentes = st.text_area(
        "Resumo das últimas entregas, gaps ou comportamentos (Pauta):", 
        placeholder="Ex: Entregou o projeto X com atraso, mas ajudou o time novo a se adaptar..."
    )
